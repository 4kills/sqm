...
Entwickler-Team aufgeteilt auf Deutschland und Australien. 

Keine fest vorgegebenen Release-Zyklen. Releases, wenn neues Feature fertig.

Releases oft Freitags durch australisches Team. 

Keinerlei automatisierte Tests. 

Viele Bugs in Production. Oft hot-fixes nötig.

Der CI/CD prozess für deployment auf der entwicklungs-instanz dauert 15 minuten. 
...
Codequalität in schrecklichem Zustand. Viele duplikative Code-Stücke, 
wenig Struktur, keine Aufteilung der Architektur in Schichten. 
Immer gegen Implementationen programmiert, anstatt gegen Abstraktionen.

Unleserlichkeit des Codes. 40-50 Zeilen lange, verschachtelte SQL-Statements, 
die viel Code-Duplikate enthalten.

Keine Code-Reviews 

Kanban-Board mit Tasks und Prioritäten 
aber kein Sprint-Planning und kein Sprint-Review. 

SCRUM-Meetings zweimal pro Woche aber mit ganzer Abteilung (nicht nur Entwickler, 
sondern auch Designer, Manager, Content-Moderators etc). Dadurch sehr ineffizient. 